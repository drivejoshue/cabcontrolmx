...
return new class extends Migration
{
    public function up(): void
    {
        // NOTA:
        // - Esto asume MySQL 8+
        // - Ajusta el nombre del SP si el tuyo se llama diferente.
        // - Este SP NO rellena con drivers busy/on_ride: solo considera idle (y cola por paradero).
        DB::unprepared(<<<'SQL'
DROP PROCEDURE IF EXISTS sp_offer_wave_prio_v3;
