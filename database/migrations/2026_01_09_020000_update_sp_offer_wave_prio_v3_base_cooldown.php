    ...
    WHERE q.tenant_id = p_tenant_id
      ...
      AND NOT EXISTS (
        ...
        WHERE ro2.tenant_id = p_tenant_id
          ...
          AND ro2.sent_at  >= DATE_SUB(NOW(), INTERVAL (v_expires_sec + 3) SECOND)
      )
      AND (
        SELECT COUNT(*)
...
SQL);
    ...
    {
        // Revertir con exactitud requeriría el SP previo.
        // En rollback, al menos lo eliminamos para evitar “procedimiento viejo” inconsistente.
        DB::unprepared("DROP PROCEDURE IF EXISTS sp_offer_wave_prio_v3");
    }
};
