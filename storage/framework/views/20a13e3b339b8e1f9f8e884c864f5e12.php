...
<script>
  window.ccTenant = {
    id:   <?php echo e((int)($tenant->id ?? (auth()->user()->tenant_id ?? 0))); ?>,
    name: <?php echo json_encode($tenant->name ?? '', 15, 512) ?>,
    map: {
      lat: <?php echo e((float)($tenant->latitud ?? 0)); ?>,
      lng: <?php echo e((float)($tenant->longitud ?? 0)); ?>,
      zoom: <?php echo e((int)($tenant->map_zoom ?? 14)); ?>,
