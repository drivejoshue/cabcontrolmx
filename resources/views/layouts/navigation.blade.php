    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @php
                    $user = Auth::user();
                    $avatarUrl = $user->avatar_url ?? asset('images/default_user.png');
                @endphp
                    ...
                    <x-slot name="trigger">
                        ...
                        >
                            <div class="flex items-center space-x-2">
                                ...
                                {{-- Nombre (truncado para que quepa bien) --}}
                                <span class="max-w-[9rem] truncate text-left">
                                    {{ $user->name }}
                                </span>

                                {{-- Flecha --}}
                                <svg class="ml-1 shrink-0 fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
