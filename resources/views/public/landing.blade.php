...
@section('title','Orbana Dispatch — Acceso')

{{-- Header minimal: solo logo + botón Entrar --}}
@section('nav')
<header id="header" class="header d-flex align-items-center fixed-top" style="background:#0b1220;">
  <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
    <a href="{{ route('public.landing') }}" class="logo d-flex align-items-center text-decoration-none">
      <img src="{{ asset('images/landing/logo.png') }}"
           alt="Orbana"
           style="height:34px;width:auto;"
           onerror="this.src='{{ asset('vendor/FlexStart/assets/img/logo.png') }}'">
    </a>
      ...
      <div class="col-12 col-lg-9 col-xl-8">
        ...
        <div class="text-center mb-4">
          <div class="d-flex justify-content-center mb-3">
            <div class="gate-logo">
              {{-- Logo compacto (sin texto) recomendado --}}
              <img src="{{ asset('images/landing/logo-symbol.png') }}"
                   alt="Orbana"
                   onerror="this.src='{{ asset('images/landing/logo.png') }}'">
            </div>
          </div>
        ...
        <div class="gate-card p-4 p-md-5">
          <div class="row g-3 align-items-center">
            ...
            <div class="col-12 col-md-5 d-grid gap-2">
              <a href="{{ route('login') }}" class="btn btn-orbana btn-orbana-primary">
                <i class="bi bi-box-arrow-in-right me-1"></i> Entrar
              </a>
              <a href="{{ route('public.signup') }}" class="btn btn-orbana btn-orbana-outline">
          ...
          <div class="row g-3">
            <div class="col-12 col-md-4">
              <a class="gate-linkcard" href="{{ url('/docs') }}">
            ...
            <div class="col-12 col-md-4">
              <a class="gate-linkcard" href="{{ url('/legal') }}">
                <div class="d-flex gap-3">
            ...
            <div class="col-12 col-md-4">
              <a class="gate-linkcard" href="{{ url('/soporte') }}">
                <div class="d-flex gap-3">
          ...
          <div class="text-center mt-4 gate-footer small">
            © {{ date('Y') }} Orbana · Operación en tiempo real
          </div>
        </div>
