...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
      <a href="{{ route('partner.vehicles.show', ['id'=>$vehicle->id]) }}" class="btn btn-outline-secondary">Volver</a>
    </div>
  </div>
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <form method="POST"
            action="{{ route('partner.vehicles.documents.store',$vehicle->id) }}"
              ...
              <tr>
                ...
                <td class="text-end">
                  <a class="btn btn-sm btn-outline-secondary"
                     href="{{ route('partner.vehicles.documents.download',$d->id) }}">
                    Descargar
                  </a>
                  ...
                  @if($d->status !== 'approved')
                    <form class="d-inline"
                          method="POST"
                          action="{{ route('partner.vehicles.documents.delete',$d->id) }}">
                      @csrf
